...
Partial Public Class perpustakaanDataSet1
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/perpustakaanDataSet1.xsd"
    ...
    Partial Public Class bukuDataTable
        ...
        Private columntahun_terbir As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public ReadOnly Property tahun_terbirColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columntahun_terbir
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddbukuRow(ByVal no_buku As String, ByVal judul As String, ByVal pengarang As String, ByVal tahun_terbir As Short, ByVal jenis_buku As String, ByVal status As String) As bukuRow
            Dim rowbukuRow As bukuRow = CType(Me.NewRow,bukuRow)
            Dim columnValuesArray() As Object = New Object() {no_buku, judul, pengarang, tahun_terbir, jenis_buku, status}
        ...
        Friend Sub InitVars()
            ...
            Me.columntahun_terbir = MyBase.Columns("tahun_terbir")
        ...
        Private Sub InitClass()
            ...
            Me.columntahun_terbir = New Global.System.Data.DataColumn("tahun_terbir", GetType(Short), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columntahun_terbir)
    ...
    Partial Public Class bukuRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property tahun_terbir() As Short
            Get
                Try 
                    Return CType(Me(Me.tablebuku.tahun_terbirColumn),Short)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'tahun_terbir' in table 'buku' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablebuku.tahun_terbirColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function Istahun_terbirNull() As Boolean
            Return Me.IsNull(Me.tablebuku.tahun_terbirColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub Settahun_terbirNull()
            Me(Me.tablebuku.tahun_terbirColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace perpustakaanDataSet1TableAdapters
    ...
    Partial Public Class bukuTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("tahun_terbir", "tahun_terbir")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `buku` WHERE ((`no_buku` = ?) AND ((? = 1 AND `judul` IS NULL) OR (`j"& _ 
                ...
                " 1 AND `tahun_terbir` IS NULL) OR (`tahun_terbir` = ?)) AND ((? = 1 AND `jenis_b"& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_tahun_terbir", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_tahun_terbir", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `buku` (`no_buku`, `judul`, `pengarang`, `tahun_terbir`, `jenis_buku`"& _ 
                ", `status`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("tahun_terbir", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `buku` SET `no_buku` = ?, `judul` = ?, `pengarang` = ?, `tahun_terbir` = ?"& _ 
                ", `jenis_buku` = ?, `status` = ? WHERE ((`no_buku` = ?) AND ((? = 1 AND `judul` "& _ 
                "IS NULL) OR (`judul` = ?)) AND ((? = 1 AND `pengarang` IS NULL) OR (`pengarang` "& _ 
                "= ?)) AND ((? = 1 AND `tahun_terbir` IS NULL) OR (`tahun_terbir` = ?)) AND ((? ="& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("tahun_terbir", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_tahun_terbir", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_tahun_terbir", Global.System.Data.OleDb.OleDbType.SmallInt, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tahun_terbir", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT no_buku, judul, pengarang, tahun_terbir, jenis_buku, status FROM buku"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As perpustakaanDataSet1.bukuDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As perpustakaanDataSet1.bukuDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As perpustakaanDataSet1.bukuDataTable = New perpustakaanDataSet1.bukuDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As perpustakaanDataSet1.bukuDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_no_buku As String, ByVal Original_judul As String, ByVal Original_pengarang As String, ByVal Original_tahun_terbir As Global.System.Nullable(Of Short), ByVal Original_jenis_buku As String, ByVal Original_status As String) As Integer
            ...
            End If
            If (Original_tahun_terbir.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_tahun_terbir.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal no_buku As String, ByVal judul As String, ByVal pengarang As String, ByVal tahun_terbir As Global.System.Nullable(Of Short), ByVal jenis_buku As String, ByVal status As String) As Integer
            ...
            End If
            If (tahun_terbir.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(tahun_terbir.Value,Short)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal no_buku As String, ByVal judul As String, ByVal pengarang As String, ByVal tahun_terbir As Global.System.Nullable(Of Short), ByVal jenis_buku As String, ByVal status As String, ByVal Original_no_buku As String, ByVal Original_judul As String, ByVal Original_pengarang As String, ByVal Original_tahun_terbir As Global.System.Nullable(Of Short), ByVal Original_jenis_buku As String, ByVal Original_status As String) As Integer
            If (no_buku Is Nothing) Then
                Throw New Global.System.ArgumentNullException("no_buku")
            Else
            ...
            End If
            If (tahun_terbir.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(tahun_terbir.Value,Short)
            Else
            ...
            If (Original_tahun_terbir.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_tahun_terbir.Value,Short)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal judul As String, ByVal pengarang As String, ByVal tahun_terbir As Global.System.Nullable(Of Short), ByVal jenis_buku As String, ByVal status As String, ByVal Original_no_buku As String, ByVal Original_judul As String, ByVal Original_pengarang As String, ByVal Original_tahun_terbir As Global.System.Nullable(Of Short), ByVal Original_jenis_buku As String, ByVal Original_status As String) As Integer
            Return Me.Update(Original_no_buku, judul, pengarang, tahun_terbir, jenis_buku, status, Original_no_buku, Original_judul, Original_pengarang, Original_tahun_terbir, Original_jenis_buku, Original_status)
        End Function
    End Class
